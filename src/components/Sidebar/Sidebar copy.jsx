...
const Sidebar = (props) => {
  const { activeTab, blocklistIgnore, setBlocklistIgnore, dublicatesIgnore, setDublicatesIgnore } = props;
  const [currentTab, setCurrentTab] = useState('filter');

  return (
    <nav className={cn("col-md-2 d-none d-md-block bg-light sidebar", {
        ...
        <ul className="nav flex-column">
          <li className="nav-item">
            <a className={cn('nav-link', {
              active: currentTab === 'filter'
            })} href="#filter" onClick={(e) => {
              e.preventDefault();
